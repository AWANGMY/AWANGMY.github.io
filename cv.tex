...
{B.Eng. in Mechanical Engineering}{09.2020 -- 06.2025}
...
{Master Student, Graduate School of Engineering}{10.2025 -- Present}
}
...
\begin{itemize}
  ...
  \item Engineered movement features and trained machine-learning models to predict fatigue level during human motion tasks.
  \item Developed reproducible workflows for dataset management, model evaluation, and result visualization in Python.
\end{itemize}
...
\cvitem{Computer Vision \& ML}{Multi-camera RGB-D processing, keypoint extraction, Kalman filtering, scikit-learn}\\
